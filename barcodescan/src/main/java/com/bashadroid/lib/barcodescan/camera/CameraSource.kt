...
private constructor() {
    ...
    @StringDef(FOCUS_MODE_CONTINUOUS_PICTURE, FOCUS_MODE_CONTINUOUS_VIDEO, FOCUS_MODE_AUTO, FOCUS_MODE_EDOF, FOCUS_MODE_FIXED, FOCUS_MODE_INFINITY, FOCUS_MODE_MACRO)
    @Retention(RetentionPolicy.SOURCE)
    private annotation class FocusMode

    @StringDef(FLASH_MODE_ON, FLASH_MODE_OFF, FLASH_MODE_AUTO, FLASH_MODE_RED_EYE, FLASH_MODE_TORCH)
    @Retention(RetentionPolicy.SOURCE)
