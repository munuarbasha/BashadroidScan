...
import com.bashadroid.lib.barcodescan.camera.CameraSource;
import com.bashadroid.lib.barcodescan.camera.CameraSourcePreview;
import com.bashadroid.lib.barcodescan.camera.GraphicOverlay;
...
public class BarcodeReader extends Fragment implements View.OnTouchListener, BarcodeGraphicTracker.BarcodeGraphicTrackerListener {
    ...
    @Override
    public void onScannedMultiple(@NotNull List<? extends Barcode> barcodes) {
        if (mListener != null && !isPaused) {
            mListener.onScannedMultiple((List<Barcode>) barcodes);
        }
    }
